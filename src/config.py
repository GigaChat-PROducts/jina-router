...
class RAGSettings(BaseSettings):
    ...
    quota_tasks: list[QuotaTask] = Field(
        default_factory=lambda: [
            QuotaTask(name="documents", multiplier=1.0814694121084567),
